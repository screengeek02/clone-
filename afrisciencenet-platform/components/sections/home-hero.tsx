export function HomeHero() {
  return (
    <section className="card p-8">
      ...
      <h1 className="mt-2 text-4xl font-bold text-navy">Connecting Africa’s Research Infrastructure</h1>
      <p className="mt-3 max-w-3xl">Discover equipment, institutions, experts, and funding opportunities that accelerate research collaboration across Africa.</p>
      ...
      <form action="/search" className="mt-6 flex flex-col gap-3 sm:flex-row">
        <input name="q" placeholder="Search equipment, researchers, institutions, funding, collaborations..." className="w-full rounded-full border px-4 py-3" />
